...
class LocationCustomDropDownButton extends StatefulWidget {
  ...
  @override
  State<LocationCustomDropDownButton> createState() => _LocationCustomDropDownButtonState();
}

class _LocationCustomDropDownButtonState extends State<LocationCustomDropDownButton> {
            ...
            child: DropdownButtonHideUnderline(
              child: DropdownButton2<PurposeModel>(
                ...
                iconStyleData: IconStyleData(
                  icon: Image.asset(Images.upIcon, width: 22.w, height: 24.h),
                ),
              ),
            ),
          ),
